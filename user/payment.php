					...
					<form class="card-details " method="post">
						<div class="form-group mb-0">
								<p class="text-warning mb-0">Card Number</p> 
                          		<input type="text" name="cardnumber1" placeholder="enter here" size="17" id="cno" maxlength="12" required>
...
if(isset($_POST['pay']))
{
$cardno=$_POST['cardnumber1'];
$name=$_POST['name'];
$expiry=$_POST['expiry'];
$cvv=$_POST['cvv'];
$cost=$_POST['cost'];
  $query="INSERT INTO `payment`(`id`, `cardnumber`, `name`, `expiry`, `cvv`, `cost`) VALUES ('','$cardno','$name','$expiry','$cvv','$cost')";
	 // $conn->close();
