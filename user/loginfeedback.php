...
<link rel="stylesheet" href="css/loginfeedback.css">
...
<body>
  ...
  <div class="site-wrap">
    ...
    <!--searchbar -->
    <img class="ml-1 bus" data-aos="fade-right" src="images/travel.png" style="max-width: 150px;margin-top:30px;">
    ...
    <footer class="page-footer font-small stylish-color-dark pt-4">
      ...
      <div class="container text-center text-md-left py-4">
        ...
        <div class="row">
          ...
          <a href="applypass.php"><input type="submit" name="applyforpass" type="login" value="applyforpass" class="aply-login"/></a>
          <a href="feedback.php"><input type="submit" name="givefeedback" type="login" value="givefeedback" class="aply-feed"/></a>
