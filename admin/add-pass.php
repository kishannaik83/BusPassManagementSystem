...
$qry=mysqli_query($con,"SELECT *FROM `passform` WHERE passform.id=".$id);
while ($row=mysqli_fetch_array($qry)) {
?>
<?php
$fullname=$row['fullname'];
$profile_image='uploaduser/'.$row['profileimage'];
$email=$row['email'];
      ...
      <form action="" method="post" name="" enctype='multipart/form-data'>
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="file" placeholder="" name="profile_image" value="<?php echo $profile_image ?>" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box"><span class="details">identity type</span><select type="text" name="identitytype"  class="input-box" required='true'>
            ...
            <div class="input-box">
              ...
              <input type="text" placeholder="Enter your card no" name="identitycardno" value="<?php echo $identitycardno?> " required>
            </div>
            <div class="input-box">
              <span class="details">Source</span>
              <input type="text" placeholder="enter here" name="source"value="<?php echo $source ?> "required>
            </div>
            <div class="input-box">
              <span class="details">Destination</span>
              <input type="text" placeholder="Enter here" name="destination" value="<?php echo $destination ?>" required>
            </div>
            <div class="input-box">
              <span class="details">From Date</span>
              <input type="date" placeholder="" name="fromdate"  value="<?php echo $fromdate ?>" required>
            </div>
            <div class="input-box">
              <span class="details">To date</span>
              <input type="date" placeholder="" name="todate" value="<?php echo $todate ?>" required>
            </div>
            <div class="input-box">
                <span class="details">pass number</span>
                <input type="text" placeholder="enter here" name="passnumber"  <?php  $passnumber=rand(100,1000); echo $passnumber; ?>  required>
              </div>
        <div class="button">
...
$passnumber=$_POST['passnumber'];
  ...
  $query="INSERT INTO `adminpass`(`fullname`, `profileimage`, `email`, `phonenumber`,`clgname`, `identitytype`, `identitycardno`, `source`, `destination`,`fromdate`, `todate`,`passnumber`) VALUES ('$fullname','$profileimage','$email','$phonenumber','$clgname','$identitytype','$identitycardno','$source','$destination','$fromdate','$todate','$passnumber')";
	 // $conn->close();
